...
import { HttpErrorHandlerInitializer } from './initializers/http-error-handler.initializer'
...
export const DynaAutoimport: Autoimport = {
  initializers: [CacheControllersInitializer, FixControllersInitializer, FixRoutesInitializer, ListenHttpRequestsInitializer, HttpErrorHandlerInitializer],
}
